...
# Handle types that have hand-written implementations and should NOT
# be auto-generated by the autowrapper.  They are still recognised as
# handle types for parameter mapping in generated wrapper functions.
HANDLE_TYPES_EXISTING: set[str] = {
    "occtl_graph_t",
}
...
def is_auto_handle_type(c_type: str) -> bool:
    ...
    if (
        ...
        or base in HANDLE_TYPES_EXISTING
...
def godot_param_type(c_type: str) -> str:
    ...
    if ptr_match:
        ...
        if typed in HANDLE_TYPES or typed in HANDLE_TYPES_EXISTING:
...
def is_out_param(c_type: str, name: str, parent_return_type: str) -> bool:
    ...
    if ptr_match:
        ...
        if inner in HANDLE_TYPES or inner in HANDLE_TYPES_EXISTING:
            return False
