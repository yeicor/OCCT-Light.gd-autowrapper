#ifndef OCCTLPRIMEXTRUDETWISTINFO_H
#define OCCTLPRIMEXTRUDETWISTINFO_H
...
class OcctlPrimExtrudeTwistInfo : public godot::RefCounted {
    GDCLASS(OcctlPrimExtrudeTwistInfo, godot::RefCounted)
protected:
...
public:
    ...
    occtl_prim_extrude_twist_info_t to_c() const;
    static Ref<OcctlPrimExtrudeTwistInfo> from_c(const occtl_prim_extrude_twist_info_t& val);
    void copy_from_c(const occtl_prim_extrude_twist_info_t& val);
};

#endif // OCCTLPRIMEXTRUDETWISTINFO_H
