#ifndef OCCTLPOLYGON3DVIEW_H
#define OCCTLPOLYGON3DVIEW_H
...
class OcctlPolygon3dView : public godot::RefCounted {
    GDCLASS(OcctlPolygon3dView, godot::RefCounted)
protected:
...
public:
    ...
    occtl_polygon3d_view_t to_c() const;
    static Ref<OcctlPolygon3dView> from_c(const occtl_polygon3d_view_t& val);
    void copy_from_c(const occtl_polygon3d_view_t& val);
};

#endif // OCCTLPOLYGON3DVIEW_H
