#ifndef OCCTLPRIMPIPESHELLLINEARLAWINFO_H
#define OCCTLPRIMPIPESHELLLINEARLAWINFO_H
...
class OcctlPrimPipeShellLinearLawInfo : public godot::RefCounted {
    GDCLASS(OcctlPrimPipeShellLinearLawInfo, godot::RefCounted)
protected:
...
public:
    ...
    double get_scale_first() const;
    void set_scale_first(double val);
    double get_scale_last() const;
    void set_scale_last(double val);
    int get_mode() const;
    ...
    occtl_prim_pipe_shell_linear_law_info_t to_c() const;
    static Ref<OcctlPrimPipeShellLinearLawInfo> from_c(const occtl_prim_pipe_shell_linear_law_info_t& val);
    void copy_from_c(const occtl_prim_pipe_shell_linear_law_info_t& val);
};

#endif // OCCTLPRIMPIPESHELLLINEARLAWINFO_H
