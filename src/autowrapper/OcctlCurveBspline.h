#ifndef OCCTLCURVEBSPLINE_H
#define OCCTLCURVEBSPLINE_H
...
class OcctlCurveBspline : public godot::RefCounted {
    GDCLASS(OcctlCurveBspline, godot::RefCounted)
protected:
...
public:
    ...
    occtl_curve_bspline_t to_c() const;
    static Ref<OcctlCurveBspline> from_c(const occtl_curve_bspline_t& val);
    void copy_from_c(const occtl_curve_bspline_t& val);
};

#endif // OCCTLCURVEBSPLINE_H
