#ifndef OCCTLPRIMPIPESHELLINTERPOLATEDLAWINFO_H
#define OCCTLPRIMPIPESHELLINTERPOLATEDLAWINFO_H
...
class OcctlPrimPipeShellInterpolatedLawInfo : public godot::RefCounted {
    GDCLASS(OcctlPrimPipeShellInterpolatedLawInfo, godot::RefCounted)
protected:
...
public:
    ...
    PackedFloat64Array get_scales() const;
    void set_scales(PackedFloat64Array val);
    int get_sample_count() const;
    void set_sample_count(int val);
    int get_mode() const;
    ...
    occtl_prim_pipe_shell_interpolated_law_info_t to_c() const;
    static Ref<OcctlPrimPipeShellInterpolatedLawInfo> from_c(const occtl_prim_pipe_shell_interpolated_law_info_t& val);
    void copy_from_c(const occtl_prim_pipe_shell_interpolated_law_info_t& val);
};

#endif // OCCTLPRIMPIPESHELLINTERPOLATEDLAWINFO_H
